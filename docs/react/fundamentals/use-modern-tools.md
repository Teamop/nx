...
So running `tao g @nrwl/react:application frontend` will create:
...
By default, Nx uses Jest for both React and Node.js applications. So if you run `tao g application frontend`, you will get:
