...
tao g @nrwl/react:application myapp # Generate a React Application
```
...
tao g @nrwl/angular:application myapp # Generate an Angular Application
```
...
tao g @nrwl/nest:application myapp # Generate a Nest Application
```
...
tao g @nrwl/express:application myapp # Generate an Express Application
```
...
- `tao serve myapp` to serve the application
- `tao build myapp` to build the application
- `tao test myapp` to test the application
- `tao lint myapp` to lint the application
...
```bash
tao g @nrwl/react:library mylib # Generate a React Library
```

Angular Libraries:

```bash
tao g @nrwl/angular:library mylib # Generate an Angular Library
```

Typescript Libraries:

```bash
tao g @nrwl/workspace:library mylib # Generate a Typescript Library
```
...
- `tao test mylib` to test the library
- `tao lint mylib` to lint the library

> By default, libraries are only buildable in the context of an application.

> To be able to build a library independently, you can pass `--publishable` when creating it. You can then run `tao build mylib` to build it, and then publish the results to an NPM registry.
